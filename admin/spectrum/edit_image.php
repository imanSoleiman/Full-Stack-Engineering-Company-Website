...
// Fetch image
$image = $conn->query("SELECT * FROM spectrum_images WHERE id=$id")->fetch_assoc();
...
if(isset($_POST['submit'])){
    ...
    $stmt = $conn->prepare("UPDATE spectrum_images SET header=?, description=?, image_name=? WHERE id=?");
...
<h1><i class="fa fa-edit"></i> Edit Image for Category ID <?= $category_id ?></h1>
